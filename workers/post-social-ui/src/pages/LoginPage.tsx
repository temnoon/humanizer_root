...
export const LoginPage: Component = () => {
  ...
  const handleDiscord = () => {
    window.location.href = authStore.getDiscordLoginUrl();
  };
    ...
    <div class="container" style={{ 'max-width': '500px', 'padding-top': '4rem' }}>
      ...
      <div class="card">
        <button
          ...
          style={{ width: '100%', 'margin-bottom': 'var(--space-sm)', display: 'flex', 'align-items': 'center', 'justify-content': 'center', gap: '0.75rem' }}
        >
        ...
        <button
          ...
          class="btn btn-secondary"
          style={{ width: '100%', 'margin-bottom': 'var(--space-lg)', display: 'flex', 'align-items': 'center', 'justify-content': 'center', gap: '0.75rem' }}
        >
