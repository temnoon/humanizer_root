-- Migration 0011: User Attributes and Dialogue Sessions (Production Version)
-- Purpose: Support for LLM-assisted attribute builder
-- Date: 2025-11-10
-- Modified: Using existing production user ID
...
-- Insert a few example personas for the admin user (dreegle@gmail.com)
...
(
  ...
  'e16d5465-24b6-4d11-bf82-6bb25b8220dd',
  'persona',
