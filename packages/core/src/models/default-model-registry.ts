...
export const DEFAULT_MODELS: VettedModel[] = [
  ...
  // ─────────────────────────────────────────────────────────────────
  // Cloudflare Workers AI Models (CLOUD-TRUSTED - runs on our infrastructure)
  // These models require Humanizer API key and are only available to paid tiers
  // ─────────────────────────────────────────────────────────────────
  {
    ...
    maxBatchSize: 100,
    tokenLimit: 512,
    costPer1kTokens: { input: 0.000011, output: 0 }, // ~$0.011 per million tokens
    vettingStatus: 'approved',
    aliases: ['cf-bge-base', 'bge-base', 'workers-embed'],
    description: 'Cloudflare Workers AI BGE Base embedding model',
    privacyLevel: 'cloud-trusted',
    privacyInfo: {
      level: 'cloud-trusted',
      warning: 'Processed on Humanizer cloud infrastructure (Cloudflare Workers)',
      dataRetention: 'No retention - inference only',
      mayTrainOnData: false,
      privacyPolicyUrl: 'https://www.cloudflare.com/privacypolicy/',
    },
    requiresHumanizerApiKey: true,
    minimumTier: 'pro',
    performanceProfile: {
      avgLatencyMs: 30,
      qualityScore: 0.88,
  ...
  },
  {
    ...
    maxBatchSize: 100,
    tokenLimit: 512,
    costPer1kTokens: { input: 0.000011, output: 0 },
    vettingStatus: 'approved',
    aliases: ['cf-bge-large', 'bge-large'],
    description: 'Cloudflare Workers AI BGE Large embedding model (higher quality)',
    privacyLevel: 'cloud-trusted',
    privacyInfo: {
      level: 'cloud-trusted',
      warning: 'Processed on Humanizer cloud infrastructure (Cloudflare Workers)',
  ...
  },
  {
    ...
    vettingStatus: 'approved',
    aliases: ['cf-llama-3.1-8b', 'workers-llama', 'cf-llama'],
    description: 'Cloudflare Workers AI Llama 3.1 8B Instruct',
    privacyLevel: 'cloud-trusted',
    privacyInfo: {
      level: 'cloud-trusted',
      warning: 'Processed on Humanizer cloud infrastructure (Cloudflare Workers)',
  ...
  },
  {
    ...
    vettingStatus: 'approved',
    aliases: ['cf-llama-3.2-3b', 'cf-llama-small'],
    description: 'Cloudflare Workers AI Llama 3.2 3B Instruct (fast, economical)',
    privacyLevel: 'cloud-trusted',
    privacyInfo: {
      level: 'cloud-trusted',
      warning: 'Processed on Humanizer cloud infrastructure (Cloudflare Workers)',
  ...
  },
  {
    ...
    vettingStatus: 'approved',
    aliases: ['cf-mistral-7b', 'workers-mistral'],
    description: 'Cloudflare Workers AI Mistral 7B Instruct',
    privacyLevel: 'cloud-trusted',
    privacyInfo: {
      level: 'cloud-trusted',
      warning: 'Processed on Humanizer cloud infrastructure (Cloudflare Workers)',
    ...
    performanceProfile: {
      ...
      qualityScore: 0.84,
      lastVetted: new Date('2026-01-27'),
      approvedCapabilities: ['completion', 'chat', 'code'],
    },
  },
  {
    ...
    vettingStatus: 'approved',
    aliases: ['cf-phi-2', 'workers-phi'],
    description: 'Cloudflare Workers AI Phi-2 (ultra-fast, budget-friendly)',
    privacyLevel: 'cloud-trusted',
    privacyInfo: {
      level: 'cloud-trusted',
      warning: 'Processed on Humanizer cloud infrastructure (Cloudflare Workers)',
