...
// ═══════════════════════════════════════════════════════════════════
// SENTENCE - The Atom of Narrative
// ═══════════════════════════════════════════════════════════════════
 ...
 */
export type SICCategory =
  | 'polished-human'   // High SIC, High Neatness - Expert craft with scars
  | 'raw-human'        // High SIC, Low Neatness - Diary, live draft, authentic
  | 'neat-slop'        // Low SIC, High Neatness - LLM zone
  | 'messy-low-craft'; // Low SIC, Low Neatness - Struggling human

// ═══════════════════════════════════════════════════════════════════
// DENSITY MATRIX - Subjective State Representation
// ═══════════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════════
// ARCHIVE - The User's Accumulated Writings
// ═══════════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════════
// CURATOR - The Agent Operating on the Archive
// ═══════════════════════════════════════════════════════════════════
...
export interface CuratorFilters {
  ...
  sources?: ArchiveType[];
  sicRange?: { min: number; max: number };
  searchQuery?: string;
}
...
// ═══════════════════════════════════════════════════════════════════
// COMPOSITION - What Emerges from Curation
// ═══════════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════════
// VECTOR TYPES - Semantic Position & Trajectory
// ═══════════════════════════════════════════════════════════════════
